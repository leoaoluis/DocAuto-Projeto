function getAddressElements() {
    const addressElement = document.querySelector('.address-container p:nth-child(2)');
    const nifElement = document.querySelector('.address-container p:nth-child(3)');
    const phoneElement = document.querySelector('.address-container p:nth-child(4)');
